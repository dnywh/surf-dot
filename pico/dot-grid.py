...
if __name__ == "__main__":
    ...
    for kk in range(rows):
        ...
        for jj in range(cols):
            ...
            itemScale = random.randint(1, cellScale)
    ...
    # Fill the entire screen with white. Maybe unnecessary as the above step does this too? Seems to help stop artefacts on the let side FWIW
    epd.fill(0)
